...
fn test_crud_operations_with_planner() -> Result<()> {
    ...
    
    {
        ...
        // INSERT
        let affected = db.execute("INSERT INTO products (id, name, price) VALUES (1, 'Widget', 9.99)")?;
        assert_eq!(affected, 1);
        
        let affected = db.execute("INSERT INTO products (id, name, price) VALUES (2, 'Gadget', 19.99)")?;
        assert_eq!(affected, 1);
