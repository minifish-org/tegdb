...
fn main() -> Result<()> {
    ...
    db.execute("INSERT INTO order_items (order_id, product_id, quantity, price) VALUES (100, 1, 2, 29.99)")?;
    db.execute("INSERT INTO order_items (order_id, product_id, quantity, price) VALUES (100, 2, 1, 15.50)")?;
    db.execute("INSERT INTO order_items (order_id, product_id, quantity, price) VALUES (101, 1, 3, 29.99)")?;
    db.execute("INSERT INTO order_items (order_id, product_id, quantity, price) VALUES (101, 3, 1, 45.00)")?;
    
    // Try to insert duplicate composite primary key
    println!("3. Testing composite primary key constraint...");
    match db.execute("INSERT INTO order_items (order_id, product_id, quantity, price) VALUES (100, 1, 5, 35.00)") {
    ...
    for row in result.rows() {
        ...
        println!("  Order: {}, Product: {}, Qty: {}, Price: ${:.2}", 
